...
function buildIncomeSheet(
  ...
  bookings.forEach((b, idx) => {
    ...
    setCell(11, { formula: `MAX(0,H${r}-J${r}-M${r})`, result: selisih },    { numFmt: idrFmt, align: ALIGN_RIGHT })
  ...
  const totalDefs: { col: number; letter: string; result: number; cellFill: string; font: Partial<ExcelJS.Font> }[] = [
    { col: 8,  letter: 'H', result: totGross,   cellFill: 'FFFFFF00',      font: FONT_BOLD  },
    ...
    { col: 13, letter: 'M', result: totNett,     cellFill: 'FFFFFF00',      font: FONT_BOLD  },
    { col: 16, letter: 'P', result: totPB1,      cellFill: 'FFFFFF00',      font: FONT_RED   },
    { col: 17, letter: 'Q', result: totOwner,    cellFill: FILL_OWNER_GREEN, font: FONT_BOLD },
  ]
